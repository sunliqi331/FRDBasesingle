...
import com.its.common.utils.ServletUtils;
...
public class DynamicSpecifications {
	...
	//private static final String LONG_DATE = "yyyy-MM-dd mm:HH:ss";  //历史记录
	private static final String LONG_DATE = "yyyy-MM-dd HH:mm:ss";
	//private static final String TIME = "mm:HH:ss"; //历史记录
...
//							filter.setValue(convert2Date((String)filter.getValue()));
							...
							if (filter.getValue() instanceof String) {
								...
								filter.setValue( convert2Date(sdf.format(filter.getValue())));
							}
	...
	private static Date convert2Date(String dateString) {
		...
		try {
			...
			try {
				return sFormat.parse(SHORT_DATE);
