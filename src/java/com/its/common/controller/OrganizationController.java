...
import com.its.common.service.OrganizationService;
...
public class OrganizationController {
	...
	@RequestMapping(value="/data/{parentOrganizationId}")
	@ResponseBody
	public Map<String, Object> dataList(ServletRequest request, Page page, @PathVariable Long parentOrganizationId) {
