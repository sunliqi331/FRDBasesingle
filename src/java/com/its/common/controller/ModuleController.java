...
public class ModuleController {
	...
	@RequestMapping(value="/data/{parentModuleId}")
	@ResponseBody
	public Map<String, Object> dataList(ServletRequest request, Page page, @PathVariable Long parentModuleId) {
    ...
    @RequestMapping("/checkPermissionSn/{sn}/{moduleId}")
    @ResponseBody
    public String checkPermissionSn(@PathVariable String sn,@PathVariable Long moduleId) throws JsonProcessingException{
        Map<String, Object> map = new HashMap<String, Object>();
        ObjectMapper mapper = new ObjectMapper();
        mapper.disable(SerializationFeature.FAIL_ON_EMPTY_BEANS);
        List<Permission> permissions = permissionService.findBySnAndModuleId(sn, moduleId);
        try {
