 ...
 * 完全以折线图为导向设计的实体模型
 */
public class LineChartOptionModelForList {
	...
	private List<Map<YAxisElement,Object>> yAxis = Lists.newArrayList();

    public LineChartOptionModelForList(){
...
//		this.yAxis.put(YAxisElement.type, "value");
    ...
    public List<Map<YAxisElement, Object>> getyAxis() {
        return yAxis;
    }

    public void setyAxis(List<Map<YAxisElement, Object>> yAxis) {
        this.yAxis = yAxis;
    }
