...
!function ($) {
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll,triggered) {
        var that = this,
            html = [],
            data = this.getData();
        ...
        this.resetView();
        var flag = true;
        if(triggered != undefined && !triggered){
        	flag = false;
        }
        if(flag){
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        if (g_query != '' && typeof query === 'undefined') {
        	query = g_query;
        }
        $.extend(data, query || {});
    ...
    BootstrapTable.prototype.updateCell = function (params) {
        ...
        this.initSort();
        this.initBody(true,params.triggered);
    };
