...
<body scroll="no">
  <div id="container">
    ...
    <div class="main-content">
      ...
      <div class="main-wrap fold-wrap">
        <div class="tree-list" layoutH="5" id="jbsxBox2organizationTree" >
        ...
        <div class="main-body" layoutH="0" id="jbsxBox2organizationList" class="unitBox">
  ...
  <c:set var="ModuleTitle" value="Organization"/>
