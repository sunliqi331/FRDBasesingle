...
<form method="post"
	action="${contextPath }/company/saveOrUpdateFactory/${companyinfo.parentid}"
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input id="address" type="text" name="address"
					class="form-control input-medium validate[required,maxSize[20]] required"
					maxlength="32" value="${companyinfo.address}" />
			</div>
		</div>
		<div class="form-group">
			...
			<div class="col-sm-6">
				<div class="controls input-append date form_datetime" data-date=""
					...
					<input class="form-control datetime validate[required]" type="text"
						style="background: none;" value="${companyinfo.startdate}" readonly> <span
						class="add-on"
				...
				<input type="hidden" id="dtp_input1" name="startdate" value="${companyinfo.startdate}"/>
			</div>
		</div>
	</div>
	</div>
