...
<%--          <li><a href="${contextPath}/index/ecmall">ECMall</a></li>
          ...
          <li><p><a data-toggle="modal" href="#example" >实时监控展示</a></p></li> 
        </ul>
      </div>
            ...
            <div id="myCarousel" class="carousel slide">  
               ...
               <div class="carousel-inner" >  
                  <div class="item active">  
                     <img src='${contextPath}/styles/img/index/spc.jpg' />
                     <div class="carousel-caption">SPC</div>  
                  </div>
                  <div class="item">
                     <img src='${contextPath}/styles/img/index/spc.jpg' />
                     <div class="carousel-caption">SPC</div>  
                  ...
                  <div class="item">  
                     <img src='${contextPath}/styles/img/index/grr.jpg' />
                     <div class="carousel-caption">GRR</div>  
                  </div>
                  <div class="item">  
                     <img src='${contextPath}/styles/img/index/chanpinquxian.jpg' />  
                     <div class="carousel-caption">产品曲线</div>  
                  </div>
                  <div class="item">  
                     <img src='${contextPath}/styles/img/index/driveralerm.jpg' />  
                     <div class="carousel-caption">设备告警实时监控</div>  
                  </div>
                  <div class="item">  
                     <img src='${contextPath}/styles/img/index/driveralermmonitor.jpg' />  
                     <div class="carousel-caption">设备实时监控</div>  
                  </div>
                  <div class="item">  
                     <img src='${contextPath}/styles/img/index/nenghaoshishimonitor.jpg' />  
                     <div class="carousel-caption">能耗实时监控.jpg</div>  
                  </div>
               </div>  
               <!-- 轮播（Carousel）导航 -->  
...
<!--          <div class="foot_menu"><a href="#">其它入口</a></div> -->
 ...
 <div class="foot_menu_fixed">
  ...
  <script src="${contextPath}/styles/bootstrap/2.3.1/docs/assets/js/bootstrap.min.js""></script>
  <script src="${contextPath}/styles/bootstrap/2.3.1/docs/assets/js/bootstrap-modal.js"></script>
</body>
</html>