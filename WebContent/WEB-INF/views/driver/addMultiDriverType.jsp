...
<form id="typeForm" method="post" action="${contextPath}/drivertype/saveMultiDriverType" class="form form-horizontal" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogReloadCallback);">
