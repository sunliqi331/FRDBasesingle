...
<%
    ...
    System.out.println("addDriverType---pageStart");
%>
<script>
...
<form id="typeForm" method="post" action="${contextPath}/drivertype/saveDriverType" class="form form-horizontal" enctype="multipart/form-data" onsubmit="return iframeCallback(this, dialogReloadCallback);">
   ...
   <div class="row">
      <div class="form-group">
        ...
        <div id="divOfTypename" class="col-sm-6">
          <input id="typename" type="text" name="typename" class="form-control input-medium validate[required,maxSize[20]] required" maxlength="20" />
        </div>
      </div>
      <div class="form-group">
