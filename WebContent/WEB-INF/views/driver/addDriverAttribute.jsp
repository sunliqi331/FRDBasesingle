    ...
    <div class="row">   
        <div class="form-group">
          ...
          <div id="divOfId" class="col-sm-6">
            <input type="text" id="propertykeyid" name="propertykeyid" class="form-control input-medium validate[required,maxSize[45]] required" maxlength="45"/>
          </div>
        </div>
        <div class="form-group">
          <label for="inputText" class="control-label col-sm-4"><span class="require">*&nbsp;</span>设备类型属性名</label>
          <div id="divOfName" class="col-sm-6">
            <input type="text" id="propertyname" name="propertyname" class="form-control input-medium validate[required,maxSize[45]] required" maxlength="45"/>
          </div>
        </div>
        <%-- <div class="form-group">
