...
<form method="post" action="${contextPath }/companyRole/lookup/data?rp.id=${param['rp.id'] }&prefix=${param.prefix }" data-target="lookupDataCtl" onsubmit="return navTabSearch(this)">
  ...
  <table id="lookupDataCtl" class="table table-striped" data-url="${contextPath }/management/security/role/lookup/data?rp.id=${param['rp.id'] }&prefix=${param.prefix }" data-select-item-name="${param.prefix }rolePermissionDataControls[]" data-field="dataControls" targetType="dialog" width="100%">
    <thead>
      <tr>
