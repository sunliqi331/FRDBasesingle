        ...
        <div class="main-body">
          ...
          <div id="toolBar">
            <div class="btn-group pull-left">
            	<shiro:hasPermission name="companyRole:save">
                <a class="btn btn-default1 btn-tool" target="dialog" rel="save" refresh="true" data-target="table" rel="roleCreate" href="${contextPath }/companyRole/toCreate">
                  <i class="fa fa-plus"></i>
                  <span>新增角色</span>
                </a>
                </shiro:hasPermission>
                <shiro:hasPermission name="companyRole:edit">
                <a class="btn btn-default1 btn-tool" target="dialog" rel="update" refresh="true" data-target="table" rel="roleUpdatae" href="${contextPath }/companyRole/update/{slt_uid}">
                  <i class="fa fa-pencil"></i>
                  <span>编辑角色</span>
                </a>
                </shiro:hasPermission>
                <shiro:hasPermission name="companyRole:delete">
                <a class="btn btn-default1 btn-tool" target="selectedTodo" data-target="table" href="${contextPath }/companyRole/delete" title="确认要删除?">
                <%-- <a class="btn btn-default1 btn-tool" target="ajaxTodo" data-target="table" rel="Role_navTab" href="${contextPath }/companyRole/delete/{slt_uid}" title="确认要删除该角色?"> --%>
...
<%--                 <a class="btn btn-default1 btn-tool" target="dialog" rel="assign" refresh="true" data-target="table" rel="Role_navTab" href="${contextPath }/companyRole/assign/{slt_uid}"> --%>
<!--                   <span>分配权限</span> -->
<!--                 </a> -->
            </div>
          </div>
          <table class="table table-striped" id="table" data-field="roles" data-url="${contextPath }/companyRole/data">
            <thead>
              <tr>
                 <th data-field="Number" width="50px" data-align="center">序号</th>
...
<c:set var="ModuleTitle" value="companyRole"/>
