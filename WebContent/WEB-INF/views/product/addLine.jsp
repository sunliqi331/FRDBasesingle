  ...
  <form method="post" action="${contextPath}/productline/saveProductline" class="form form-horizontal" onsubmit="return validateCallback(this, dialogReloadCallback);">
      ...
      <div class="pageFormContent" layoutH="58">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
          <label for="inputText" class="control-label col-sm-4"><span class="require">*&nbsp;</span>选择工厂</label>
          <div class="col-sm-6">
           <select id="selectCompany" name="companyinfo.id" class="form-control validate[required] required">
