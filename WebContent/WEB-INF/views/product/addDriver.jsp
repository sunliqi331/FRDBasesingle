...
<div class="pageContent">
  <form method="post" action="${contextPath}/productline/saveProductline" class="form form-horizontal" onsubmit="return validateCallback(this, subPageCallback);">
      <input type="hidden" id="companyid" value="${companyid}"/>
      <input type="hidden" id="selectCompany" value="${factoryid}"/>
...
<!--                 <th data-field="id" width="100">序号</th> -->
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default" data-dismiss="pageswitch">关闭</button>
      </div>
  </form>
</div>
<!-- Modal -->
