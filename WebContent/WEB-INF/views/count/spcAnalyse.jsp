...
$(document).ready(function(){
	...
	$("#data-confirm-Btn").click(function(){
        ...
        // $("#data-confirm").attr("href","www.baidu.com");
	...
	/*   $("#productId").change(function(event){
	  ...
	  function generateProcedurePropertySelect(procedureId,callback){
		  var option = "";
		  $.ajax({
			  url:"${contextPath}/statistics/generateProcedurePropertySpcAnalyseSelect/"+procedureId,
			  dataType:"JSON",
			  type:"POST",
			  success:function(data){
	  ...
	  function validate(){
	      if ($("#procedurePropertyId_chosen").find("span").html() == "无"){
              swal("无被测参数，请在监控配置中绑定被测参数");
	          return false;
          }
      }
        $("#searchBtn").click(function(){
		 ...
		 $("#formID").submit(function(e){
			 ...
			 if("${companyId}" != "511") {
	             ...
	             if($("#subSeq").val() == "0"){analyseDataSearch
      ...
      <div class="searchBar search_driver" style="margin-bottom: 15px;" >
       ...
       <i class="fa fa-minus search_small" onclick="searchHide()"></i>
            <i class="fa fa-plus search_small" onclick="searchShow()"></i>
             <i class="fa fa-search"></i> SPC分析条件
           </div>
           <div class="ishidden" style="margin-bottom:5px" >
        <form  method="post" action="${contextPath}/statistics/spcAnalyseDataSearch" data-target="table"
...
<!--             <div class="count_cg clearfix"> -->
      ...
      <%--<div id="toolBar clearfix " style="margin-bottom:10px;">--%>
       ...
       <%--</shiro:hasPermission>--%>
      <%--</div>--%>
       <table class="table table-striped" id="table" data-field="data">
            <thead>
              <tr>
                ...
                <%--<th data-field="value" width="150">Cp</th>--%>
                <%--<th data-field="time" width="150">Cpk</th>--%>
                <%--<th data-field="value" width="150">Pp</th>--%>

                <th data-field="mesDriverName" width="150">测量设备</th>
                <th data-field="productName" width="150">产品名称</th>
                <th data-field="productProcedureName" width="150">产品工序</th>
                <th data-field="procedurePropertyName" width="150">被测参数</th>
                <th data-field="cp" width="150">Cp</th>
                <th data-field="cpk" width="150">Cpk</th>
                <th data-field="pp" width="150">Pp</th>
                <th data-field="ppk" width="150">Ppk</th>
                <th data-field="createtime" width="150">创建时间</th>
...
<c:set var="ModuleTitle" value="spcAnalyse"/>
