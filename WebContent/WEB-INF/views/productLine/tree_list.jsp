...
<body scroll="no">
  <div id="container">
    ...
    <div class="main-content">
      <ol class="breadcrumb">
        ...
        <li><a href="${contextPath}/productline/tree_list">产线管理</a></li>
      </ol>
      <div class="main-wrap fold-wrap">
        <div class="tree-list" layoutH="5" id="jbsxBox2lineTree" >
          <c:import url="/productline/tree"/>
        </div>
        ...
        <div class="main-body" layoutH="0" id="jbsxBox2lineList" class="unitBox">
          <c:import url="/productline/list/${id}"/>
        </div>
      </div>
    </div>
  </div>
  ...
  <c:set var="ModuleTitle" value="Productline"/>
