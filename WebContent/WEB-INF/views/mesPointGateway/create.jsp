...
<form method="post" id="addForm" action="${contextPath}/mesPointGateway/saveOrUpdate" class="form form-horizontal" onsubmit="return validateCallback(this, dialogReloadCallback);">
