...
<div id="container">
  ...
  <div class="main-content">
    ...
    <div class="searchBar">
      ...
      <div class="ishidden" >
          <form class="form-inline" method="post" action="${contextPath }/mesPointGateway/data?verify=${verify}" data-target="table" onsubmit="return navTabSearch(this)">
        ...
        <div id="toolBar">
          <div class="btn-group pull-left">
				...
				<shiro:hasPermission name="verifyGateway:save">
                <a class="btn btn-default1" resizable="true" target="dialog" data-target="table" refresh="true" rel="create_pointGateway" href="${contextPath}/mesPointGateway/createVerify">
                  <i class="fa fa-plus"></i> 
                  <span>网关验证</span>
                </a>
                </shiro:hasPermission>
           		<%-- <shiro:hasPermission name="verifyGateway:edit">
                <a class="btn btn-default1" target="dialog" data-target="table" refresh="true" rel="update_pointGateway" href="${contextPath }/mesPointGateway/findById/{id}">
      			...
      			<shiro:hasPermission name="verifyGateway:delete">
...
<c:set var="ModuleTitle" value="verifyGateway"/>
