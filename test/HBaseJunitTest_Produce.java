...
@Transactional
public class HBaseJunitTest_Produce {
...
//    	scan.setStopRow(String.valueOf(Long.MAX_VALUE - 1515673074L).getBytes());
    ...
    @Test
    public void testPageFilter20180108_01_生产记录Bytimestamp() {
...
//                System.out.println("-----stopRowkey--" + String.valueOf(Long.MAX_VALUE - calendarTodayEnd.getTimeInMillis()));
    ...
    @Test
    public void testPageFilter20180111_01_生产记录() {
//    	Scan scan3 = new Scan();
//		//scan3.setCaching(9);
    ...
    public void testPageFilter20171225_01_生产记录() {
        List<String> totalResult = hTemplate.execute("procedure", new TableCallback<List<String>>() {
            ...
            public List<String> doInTable(HTableInterface table) throws Throwable {
                ...
                // 时间区间确定
                //scan.setTimeRange(Long.valueOf("1514433621000"), Long.valueOf("1514433982000"));
...
//                filters.add(filterPreFixFilter);
                ...
                Filter filter2 = new RowFilter(CompareFilter.CompareOp.EQUAL, new RegexStringComparator(
                        "^" + factoryId + "_.*" + productLineId + "_358_" + productId + "_" + produceId + "_.*"));
                filters.add(filter2);
                // FilterList filterList = new FilterList(FilterList.Operator.MUST_PASS_ALL, filters);
                //scan.setFilter(filterList);
                scan.setMaxResultSize(Long.valueOf("10"));
                ResultScanner rscanner = table.getScanner(scan);
                Map<String, String> rsMap = null;
                int index = 1;
                for (Result result : rscanner) {
